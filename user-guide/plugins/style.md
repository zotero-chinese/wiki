...
<!-- ![点击可查看详细信息](../../assets/zoterostyle-shiftp菜单1.png) -->
...
![位置越小，显示时越靠前](../../assets/zoterostyle-标签设置颜色1.png){width=33%} -->
...
<!-- ![列设置](../../assets/zoterostyle-标签1列设置.png){width=33%} -->
...
![GPT自动生成简记](../../assets/images/zotero-plugin-style/zoterostyle-AI简记.png)

![GPT指令](../../assets/images/zotero-plugin-style/zoterostyle-AI简记命令.png)
...
![文献标注1](../../assets/images/zotero-plugin-style/zoterostyle-文献标注.png)

![文献标注2](../../assets/images/zotero-plugin-style/zoterostyle-文献标注1.png)

![文献标注3](../../assets/images/zotero-plugin-style/zoterostyle-文献标注2.png)
...
![全文翻译ing](../../assets/images/zotero-plugin-style/zoterostyle-全文翻译ing.png)
...
![PDF背景色](../../assets/images/zotero-plugin-style/zoterostyle-pdf背景色.png)

::: details 点击此处了解 PDF 背景色 的详细设置和使用方法

![pdf背景色1](../../assets/images/zotero-plugin-style/zoterostyle-pdf背景色1.png)
