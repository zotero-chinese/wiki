...
您可以通过单击“添加/编辑引注”（![插入引文](../assets/icons/integration/icon-word-插入引文.png)）按钮开始添加/编辑引用。
...
单击“添加/编辑参考文献表”（![添加参考文献表](../assets/icons/integration/icon-word-添加参考文献表.png)）按钮会在光标位置插入参考文献表。
...
如果您想在之前插入的引注中增加/删除引用项目，或者修改引注中的信息，您可以将光标定位在编号内（此时编号区域会出现灰色阴影），然后单击“添加/编辑引注”（![插入引文](../assets/icons/integration/icon-word-插入引文.png)）按钮开始编辑引注。
...
但是，在极少数情况下，您可能希望将未引用的来源添加到参考书目中（例如，综述中包含的项目，但论文中未引用的项目）或删除文本中引用但不应包含在参考书目中的项目（例如，个人通信）。为此，请再次单击“添加/编辑书目”（![添加参考文献表](../assets/icons/integration/icon-word-添加参考文献表.png)）按钮以打开“编辑书目”窗口：
