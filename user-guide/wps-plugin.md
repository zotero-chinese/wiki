...
- 使用 WPS-Zotero 插件（tankwyn 开发，wangrui5015 修改），支持 Win/Linux/Mac 三种平台的 WPS 和 Zotero
- 使用 VBA，借用 Word 的插件
- 使用 WPS JavaScript API 制作的插件

wangrui5015 修改版本的 WPS-Zotero 插件地址：[https://gitee.com/wangrui5015/Zotero-WPSJS](https://gitee.com/wangrui5015/Zotero-WPSJS)
