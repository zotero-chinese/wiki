...
![Zotero 导入选项](../assets/images/endnote-zotero-import-option.png)
...
![Zotero 导入向导第二步](../assets/images/endnote-zotero-import-option2.png)
...
![Zotero 导入非标字段](../assets/images/endnote-zotero-caution.png)
...
![复制 bib](../assets/images/word-copy-bib.png)

**3、Word 引文导出**

打开 Word 文件，如下图中 ① 所示，在选项卡中点击「引用」，紧接着点击图中 ② 所示，切换引文格式

![Word 切换引文格式](../assets/images/word-export-reference.png)

选择「Bibtex Export」

![选择 bibtex export](../assets/images/word-export-reference-format.png)
...
![导入 Zotero 菜单](../assets/images/word-zotero-import.png)
