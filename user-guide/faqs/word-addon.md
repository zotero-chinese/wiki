...
3.  如果你 **在插入完成后想重新修改引用的更多信息** ，请使用 [编辑引注](../ms-word-plugin.md#自定义引注) 功能。

4.  如果你已经在一处引注中引用了多个文献，想要 **删除其中的某篇文献** ，请使用 [编辑引注](../ms-word-plugin.md#在已经添加引注的地方增删引注) 的方式进行删除。 **请不要直接在 Word 中删除角标中的数字中文字** ，这样会导致 Zotero 后续无法更新。
