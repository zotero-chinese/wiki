...
下载安装完毕后，在浏览器右上角可看到插件图标（![image.png](../../assets/image.png)或![image.png](../../assets/image-1.png)）。此时，浏览器插件已经安装成功了。

当你打开一个可抓取文献的网页时，插件图标会显示为![image.png](../../assets/image.png)，![image.png](../../assets/image-1.png)或![image.png](../../assets/image-1.png)等。稍后当我们设置完成，点击插件图标即可抓取文献。具体使用方法将在 [将条目添加进文献库](https://zotero.yuque.com/staff-gkhviy/zotero/lx3yts?view=doc_embed) 小节中展开。
